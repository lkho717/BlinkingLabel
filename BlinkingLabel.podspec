...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Leong Kah Ho/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Leong Kah Ho' => 'kahho.leong@gmail.com' }
  s.source           = { :git => 'https://github.com/Leong Kah Ho/BlinkingLabel.git', :tag => s.version.to_s }
